...
public class UpdateBook extends javax.swing.JInternalFrame {
    ...
    public UpdateBook(Book book, BookController bookController, javax.swing.JDesktopPane desktop) {
        this.book = book;
    ...
    private void btnAddActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddActionPerformed
        ...
        try {
            if (title.isEmpty() || author.isEmpty() || txtPublicationDate.getText().isEmpty()) {
                bookController.updateBook(book, null, null, null, null, 0, null);
            } else {
                LocalDate publicationDate = LocalDate.parse(txtPublicationDate.getText(), DateTimeFormatter.ofPattern("dd/MM/yyyy"));
                bookController.updateBook(book, title, author, publishingCompany, category, amount, publicationDate);
